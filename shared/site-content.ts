...
export const BRAND_IMAGES = {
  logo: "/logo.png",
  logoFallback: "/image.png",
} as const;

export const SITE_NAME = "Pizzaa Flame & Grill";
export const SITE_SHORT_NAME = "Pizzaa Flame & Grill";
export const SITE_TAGLINE = "Perth's Flame-Fired Pizza Experience";
export const SITE_DESCRIPTION =
  "Flame-fired pizza, pasta, and grill favorites served from the heart of Perth.";
export const SITE_SUPPORT_EMAIL = "shehzadraffikpizza@gmail.com";
export const SITE_ADDRESS = "145 William Street, Perth WA 6000, Australia";
export const SITE_LOCATION_SUMMARY = "145 William Street, Perth WA 6000";
export const SITE_MAP_EMBED_URL =
  "https://www.google.com/maps?q=145%20William%20Street%2C%20Perth%20WA%206000&output=embed";
...
export const MARKETING_IMAGES = {
  homeIntro: buildUnsplashUrl("1513104890138-7c749659a591", 1400, 1000),
  homeFeatured: [
    buildUnsplashUrl("1513104890138-7c749659a591", 1200, 900),
    buildUnsplashUrl("1593560708920-61dd98c46a4e", 1200, 900),
    buildUnsplashUrl("1534308983496-4fabb1a015ee", 1200, 900),
  ],
  aboutBeginning: buildUnsplashUrl("1512621776951-a57141f2eefd", 1200, 900),
